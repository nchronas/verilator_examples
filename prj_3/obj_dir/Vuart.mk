...
VERILATOR_ROOT = /media/nanimo/lowRISC_repo/lowRISC/verilator
...
sim_main_vcd.o: sim_main_vcd.cpp
	$(CXX) $(CXXFLAGS) $(CPPFLAGS) $(OPT_FAST) -c -o $@ $<

### Link rules... (from --exe)
Vuart: $(VK_USER_OBJS) $(VK_GLOBAL_OBJS) $(VM_PREFIX)__ALL.a
